...
public class PhraseMatcher implements ISparkProcessorSingleAndPair<String, String, Integer>
{
    ...
    private static final String FILE_NAME = "top-phrases.txt";
    ...
    public PhraseMatcher(Integer maxRows, String outputDirectory)
    {
    ...
    public void process(JavaRDD<String> phrases, JavaPairRDD<String, Integer> wordCounts)
    {
         ...
         */
        JavaPairRDD<String, Integer> joinedMappedValues = joined.mapValues(new Function<Tuple2<Integer, Integer>, Integer>()
        {
         ...
         */
        JavaPairRDD<Integer, String> sorted = joinedMappedValues.mapToPair(new PairFunction<Tuple2<String, Integer>, Integer, String>()
        {
        ...
        Path file = Paths.get(outputDirectory + "/" + FILE_NAME);
        try
        {
        ...
        {
            logger.error("Error when writing to file: '{}'.", file, e);
        }
    }
}
